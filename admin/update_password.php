...
<form method="post">
	...
	<div class="row">
		<div class="col-sm-4"> <b>Enter Your Old Password  </b></div>
		<div class="col-sm-5">
		<input type="password" name="op" class="form-control"/></br></div>
	</div>

	<div class="row">
		<div class="col-sm-4"><b>Enter Your New Password </b></div>
		<div class="col-sm-5">
		<input type="password" name="np" class="form-control"/></br></div>
	</div>

	<div class="row">
		<div class="col-sm-4"><b>Enter Your Confirm Password </b></div>
		<div class="col-sm-5">
		<input type="password" name="cp" class="form-control"/></br></div>
	</div>
